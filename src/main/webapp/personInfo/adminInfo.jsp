			  ...
			  <div class="panel-body">
				...
				<input type="hidden" value="${loginUser.userId}" id="userId" name="userId">
				  <div class="form-group">
					...
					<input type="text" id="uname" name="uname" value="${loginUser.uname}" class="form-control"  readonly="readonly">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">您的密码</label>
					<input type="text" id="upwd" name="upwd" value="${loginUser.upwd}" class="form-control"  readonly="readonly">
				  </div>

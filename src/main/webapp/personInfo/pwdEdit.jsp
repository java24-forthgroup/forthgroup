        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  <div class="panel-body">
				<form role="form">
				<input type="hidden" value="${findUser.userId}" id="userId" name="userId">
				  <div class="form-group">
					<label for="exampleInputPassword1">您的用户名</label>
					<input type="text" id="uname" name="uname" value="${findUser.uname}" class="form-control" readonly="readonly">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">您的密码</label>
					<input type="text" id="upwd" name="upwd" value="${findUser.upwd}" class="form-control" >
				  </div>

				  <button type="button" id="btnPwdEditSubmit" class="btn btn-danger"><i class="glyphicon glyphicon-plus"></i>修改密码</button>
				...
				$("#btnPwdEditSubmit").click(function() {
					...
					$.ajax({
						...
						success:function(result){
							alert("密码修改成功");
							window.location.href="${APPPATH}/Info/PersonInfo";
						}
					});
				});
            });

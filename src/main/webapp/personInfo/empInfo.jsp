        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				...
				<input type="hidden" value="${empInfo.aroomId}" id="aroomId" name="aroomId">
				  <div class="form-group">
					<label for="exampleInputPassword1">您的姓名</label>
					<input type="text" id="empName" name="empName" value="${empInfo.empName}" class="form-control" readonly="readonly" >
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">您的生日</label>
					<input  name="empBirthday" id="empBirthday" value="<fmt:formatDate value="${empInfo.empBirthday}" pattern="yyyy-MM-dd" /> " class="form-control" readonly="readonly">
				  </div>
				 <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<input type="email" id="empGrade" name="empGrade" class="form-control" value="${empInfo.empGrade}" readonly="readonly">
				  </div>

			  ...
			  <div class="panel-body">
				<form role="form" id="saveForm">
				  ...
				  <div class="form-group">
					<label >科室</label>
					<input type="text" class="form-control" id="aroom" name="aroom" placeholder="请输入科室">
				</div>

					<div class="form-group">
						<label >号源池编号</label>
						<input type="text" class="form-control" id="sourceId" name="sourceId" placeholder="请输入号源池编号">
					</div>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#btnSave").click(function(){
                    $.ajax({
                        url:"${APPPATH}/Skillgroup/save",
                        type:"post",
                        data:{"aroom.aroomId":$("#aroom").val(),"sourceId":$("#sourceId").val(),"skillgroupName":$("#skillgroupName").val()},

          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li style="margin-left:10px;padding-top:8px;">
				<button type="button" class="btn btn-default btn-danger">
                    <a href="${APPPATH}/help" style="color: white"> <span class="glyphicon glyphicon-question-sign"></span> 帮助</a>
				</button>
			</li>
          </ul>
	...
	<script src="${APPPATH }/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function assignPermission(rid){
            	window.location.href="${APPPATH}/role/assignPermission?roleId="+rid;
            }
            function updateRole(rid){
                window.location.href="${APPPATH}/role/update?roleId="+rid;
            }
            			...
            			if(result.flag){
            				...
            				$.each(result.obj.list,function(index,role){
		                        ...
		                        tableStr+="<td>"+(index+1)+"</td>";
		          				tableStr+="<td><input type='checkbox' class='abc' name='rids' value='"+role.roleId+"'></td>";

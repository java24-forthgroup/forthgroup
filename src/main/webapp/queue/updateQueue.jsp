			  ...
			  <div class="panel-body">
				<form role="form" id="saveForm">
				  <div class="form-group">
					<input type="hidden" id="queueId" value="${queue.queueId}" />
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#btnUpdate").click(function(){
			    	...
			    	$.ajax({
			    		url:"${pageContext.request.contextPath}/queue/updateQueue",
			    		type:"post",
			    		data:{"queueId":$("#queueId").val(),"queueNum":$("#queueNum").val(),"aroomId":$("#aroomId").val()},

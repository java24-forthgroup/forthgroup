			  ...
			  <div class="panel-body">
				<form role="form">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="aroom" name="aroom" placeholder="请输入设备名称" value="${equipment.aroom.aroomId}">
					</div>

					<div class="form-group">
						<label >设备名称</label>
						<input type="text" class="form-control" id="equipmentName" name="equipmentName" placeholder="请输入设备名称" value="${equipment.equipmentName}">
					</div>

					<div class="form-group">
						<label >设备状态</label>
						<input type="text" class="form-control" id="equipmentStatus" name="equipmentStatus" placeholder="请输入设备状态" value="${equipment.equipmentStatus}">
					</div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#btnUpdate").click(function(){
                    ...
                    if(equipmentNameVal==""){
                        layer.msg("设备名称不能为空!", {time:1000, icon:0, shift:5}, function(){});
                        return;
                    }
                    var equipmentStatusVal = $("#equipmentStatus").val();
                    if(equipmentStatusVal==""){
                        layer.msg("sheibeXZqwewqeeww名称不能为空!", {time:1000, icon:0, shift:5}, function(){});
                        return;
                    }


			    	$.ajax({
			    		url:"${APPPATH}/Equipment/update",
			    		type:"post",
			    		data:{"equipmentId":$("#equipmentId").val(),"aroom.aroomId":$("#aroom").val(),"equipmentName":$("#equipmentName").val(),"equipmentStatus":$("#equipmentStatus").val()},

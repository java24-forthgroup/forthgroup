            ...
            <li style="padding-top:8px;">
				<div class="btn-group">
				  <button type="button" class="btn btn-default btn-success dropdown-toggle" data-toggle="dropdown">
					<i class="glyphicon glyphicon-sourceType"></i> xxx <span class="caret"></span>
				  </button>
			  ...
			  <div class="panel-body">
				<form role="form" id="saveForm">
				  ...
				  <div class="form-group">
					<label >科室</label>
					<input type="text" class="form-control" id="aroom" name="aroom" placeholder="请输入设备名称">
				  </div>
					...
					<div class="form-group">
						<label >设备状态</label>
						<input type="text" class="form-control" id="equipmentStatus" name="equipmentStatus" placeholder="请输入设备状态">
					</div>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#btnSave").click(function(){
                    $.ajax({
                        url:"${APPPATH}/Equipment/save",
                        type:"post",
                        data:{"aroom.aroomId":$("#aroom").val(),"equipmentName":$("#equipmentName").val(),"equipmentStatus":$("#equipmentStatus").val()},
